...
#define EPS_BASE_ADDRESS            UCB0I2CSA
#define PAYLOAD_RUSH_BASE_ADDRESS   UCB0I2CSA
#define PAYLOAD_BRAVE_BASE_ADDRESS  UCB0I2CSA
...
#define SOLAR_PANEL_BASE_ADDRESS    EUSCI_A1_BASE
 ...
 */
// ##MODIFICADO##
#define LED_SYSTEM_DIR P1DIR
#define LED_SYSTEM_OUT P1OUT
#define LED_SYSTEM_PIN BIT0
//! \} End of led
 ...
 * \{
 */
#define PAYLOAD_RUSH_EN_DIR P3DIR
#define PAYLOAD_RUSH_EN_OUT P3OUT
#define PAYLOAD_RUSH_EN_PIN BIT2
 ...
 * \{
 */
#define I2C0_DIR P3DIR
#define I2C0_REN P3REN
#define I2C0_OUT P3OUT
#define I2C0_SEL P3SEL
#define I2C0_SDA BIT0
#define I2C0_SCL BIT1
...
#define I2C0_SDA_DIR P1DIR
#define I2C0_SDA_SEL P1SEL1
#define I2C0_SDA_PIN BIT6

#define I2C0_SCL_DIR P1DIR
#define I2C0_SCL_SEL P1SEL1
...
#define SPI1_SEL P2SEL1

#define SPI1_CLK_DIR P8DIR
#define SPI1_CLK_SEL P8SEL
#define SPI1_CLK_PIN BIT1

#define SPI1_MOSI_DIR P2DIR
#define SPI1_MOSI_SEL P2SEL1
#define SPI1_MOSI_PIN BIT5

#define SPI1_MISO_DIR P2DIR
#define SPI1_MISO_SEL P2SEL1
#define SPI1_MISO_REN P8REN
#define SPI1_MISO_OUT P2OUT
#define SPI1_MISO_PIN BIT6

#define SPI0_CLK_DIR P2DIR
#define SPI0_CLK_SEL P2SEL
#define SPI0_CLK_PIN BIT7

#define SPI0_MOSI_DIR P3DIR
#define SPI0_MOSI_SEL P3SEL
#define SPI0_MOSI_PIN BIT3

#define SPI0_MISO_DIR P3DIR
#define SPI0_MISO_SEL P3SEL
#define SPI0_MISO_PIN BIT4

#define SPI0_CSn_DIR P2DIR
#define SPI0_CSn_OUT P2OUT
#define SPI0_CSn_PIN BIT0
//! \} End of spi
...
#if HAL_VERSION == HAL_V2_1
#define TTC_GPIO1_MAIN_DIR P5DIR
#define TTC_GPIO1_MAIN_OUT P5OUT
#define TTC_GPIO1_MAIN_IN  P5IN
#define TTC_GPIO1_MAIN_PIN BIT6
#endif

#define TTC_GPIO0_MAIN_DIR P5DIR
#define TTC_GPIO0_MAIN_OUT P5OUT
#define TTC_GPIO0_MAIN_PIN BIT7
...
// ##MODIFICADO##
#define TTC_CLK_DIR         P1DIR
#define TTC_CLK_OUT         P1OUT
#define TTC_CLK_PIN         BIT5

#define TTC_MOSI_DIR        P1DIR
#define TTC_MOSI_OUT        P1OUT
#define TTC_MOSI_PIN        BIT6

#define TTC_MISO_DIR        P1DIR
#define TTC_MISO_IN         P1IN
#define TTC_MISO_PIN        BIT7
...
#define TEMP_Z_CSn_DIR P1DIR
#define TEMP_Z_CSn_OUT P1OUT
#define TEMP_Z_CSn_PIN BIT3
